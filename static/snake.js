...
function update(){
    ...
    else if(snake[snake.length-1][1] > 25 | snake[snake.length-1][1] < 0){
        loose();
    }
...
function draw(){
    snake.forEach(element =>{
        ...
        document.getElementsByClassName("snake-container")[0].appendChild(snakeElement);
    ...
    if(food != null){
        ...
        document.getElementsByClassName("snake-container")[0].appendChild(foodElement)
    }
...
function snake_main(currenTime){
    ...
    if (milliSecondsSinceLastRender < 100){return}
